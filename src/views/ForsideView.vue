    ...
    <section class="mx-4 sm:mx-8 lg:mx-16">
      ...
      <section class="relative p-8 mt-[8rem] mb-[6rem]">
        <div class="max-w-20xl mx-auto grid md:grid-cols-2">
          ...
          <img class="w-full h-[400px] object-cover" src="/assets/img/simone-og-camilla.jpg" alt="Kant performance">
      ...
      <section class="mb-10 ms-7">
        ...
        <div class="flex">
          ...
          <div class="relative">
            <img :src="mainImage" alt="Main Image" class="w-[1000px] h-[500px] object-cover transition-all duration-500 transform" :class="imageClass" id="main-image" />
          </div>
