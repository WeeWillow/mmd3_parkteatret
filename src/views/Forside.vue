...
<template>
  ...
  <div class="relative flex items-center space-x-2 bg-[#A0C298] p-2 rounded-md">
    <div class="absolute inset-0 bg-white bg-opacity-40 rounded-md"></div> 
  ...
  <button class="bg-[#A0C298] text-black px-4 py-2 rounded-lg font-semibold">
    LÆS MERE
      ...
      <div
        ref="sidebar"
        class="col-span-1 overflow-y-auto space-y-4 p-2 cursor-pointer"
      >
        <div
          v-for="(image, index) in images"
          :key="index"
          :class="[
            'flex items-center space-x-4 p-2 rounded-lg border transition-transform duration-300',
            {
              'border-green-500 scale-105': currentIndex.value === index,
              'border-gray-300': currentIndex.value !== index,
            },
          ]"
...
<section class="relative p-8 mt-[8rem] mb-[6rem]">
  <div class="max-w-20xl mx-auto grid md:grid-cols-2">
    ...
    <img 
      ...
      src="/assets/img/simone-og-camilla.jpeg" 
...
<section class="mb-10 ms-7">
    ...
    <div class="flex">
      ...
      <div class="relative">
        <img 
          :src="mainImage" 
          alt="Main Image" 
          class="w-[1000px] h-[500px] object-cover transition-all duration-500 transform" 
          :class="imageClass" 
          id="main-image"
        />
      </div>
      ...
      <div class="flex flex-col ">
        <div 
          v-for="(image, index) in [vejenHjem, niko, paddington, madam, alittlesomething]" 
          :key="index" 
        ...
        >
          <img 
            :src="image" 
            alt="Small Image" 
            class="w-[120px] h-[100px] object-cover  transition-transform hover:scale-105"
          />
        </div>
      </div>
    </div>
    ...
    <!-- FAQ -->
    <div class="w-full max-w-md mx-auto mt-8 bg-white border border-gray-300 rounded-lg p-6 px-10">
  <h1 class="text-red-400 p-4 text-center">Ofte stillede spørgsmål</h1>
...
<section class="ms-7 mt-10 pb-10">
  <div class="max-w-7xl mx-auto ">
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="relative bg-white shadow-lg rounded-lg overflow-hidden h-64 cursor-pointer">
        <img src="/assets/entry-points/biograf-entry.jpg" alt="Energi" class="w-full h-full object-cover">
      ...
      <div class="relative bg-white shadow-lg rounded-lg overflow-hidden h-64 cursor-pointer">
        <img src="/assets/entry-points/forestillinger-entry.png" alt="Animals" class="w-full h-full object-cover">
        <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black to-transparent text-white px-4 py-2">
      ...
      <div class="relative bg-white shadow-lg rounded-lg overflow-hidden h-64 cursor-pointer">
        <img src="/assets/entry-points/huset-entry.jpg" alt="Til Ungdommen" class="w-full h-full object-cover">
        <div class="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black to-transparent text-white px-4 py-2">
  ...
  // Importer for billede //
  import kant from "/assets/img/kant-main-pic.jpg";
...
// Metode til at skifte billederne
const changeImage = (newImage) => {
  // Billedet er sæt som slide-out first
  imageClass.value = 'slide-out';

  // Venter på animation bliver færdig også kommer slide-in
  setTimeout(() => {
    mainImage.value = newImage;
    imageClass.value = 'slide-in';
  }, 500); // Tiden som fortæller hvornår slide-in kommmer
};
